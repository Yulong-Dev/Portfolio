            ...
            <div className="second-home">
                ...
                <div className="bedsheet-description">
                    ...
                    <ul>
                        ...
                        <li>This Plain materials duvets are customized based on the users choice.</li>
                        <li>We also have designers duvet sets which come with pillow case, bedsheet,
                             duvet which comes in different design.</li>
                    </ul>
